              ...
              <div class="col-12 col-xl-6 col-md-6">
                  <div class="card bg-light text-black mb-4">
                      ...
                      <div class="card-body bg-dark"><h4
                              class="text-light">${customerCount}</h4>
                      </div>
                  </div>
              </div>
              <div class="col-12 col-xl-6 col-md-6">
                  <div class="card bg-light text-black mb-4">
                      <div class="card-header"><h5>Total Staff</h5></div>
                      <div class="card-body bg-dark"><h4
                              class="text-light">${staffCount}</h4>
                      </div>
                  </div>
              </div>
              <div class="col-12 col-xl-6 col-md-6">
                  <div class="card bg-light text-black mb-4">
                      ...
                      <div class="card-body bg-dark"><h4
                              class="text-light">${orderCount}</h4></div>
                  </div>
              </div>
              <div class="col-12 col-xl-6 col-md-6">
                  <div class="card bg-light text-black mb-4">
                      <div class="card-header"><h5>Total Reservations</h5></div>
                      <div class="card-body bg-dark"><h4
                              class="text-light">${reservationCount}</h4></div>
                  </div>
              </div>
          </div>
